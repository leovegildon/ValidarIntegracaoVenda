...
{
    public partial class TestePopularCombo : Form
    {
        public TestePopularCombo()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Linha["Data Venda"] = "De " + maskedTextBox1.Text + " a " + maskedTextBox2.Text;
        ...
        private void TestePopularCombo_Load(object sender, EventArgs e)
        {
