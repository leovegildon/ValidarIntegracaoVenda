    ...
    public partial class ConsultaGeral : Form
    {
      ...
      new Action(() =>
      {
        ...
        private void ConsultaGeral_Load(object sender, EventArgs e)
        {
            ...
            //string hostname = pai.hostName, usuarioLogado = pai.usuarioLogado;
            //MessageBox.Show(hostname + " " + usuarioLogado);
            //OracleConnection conn2 = new OracleConnection("Data Source=10.101.1.32/INTEGRACAOTS;User Id=pdvuser;Password=pdv1234;Integrated Security=no");
            ...
            //oCmd2.Parameters.AddWithValue("USUARIO", pai.usuarioLogado);
            //oCmd2.Parameters.AddWithValue("HOST", pai.hostName);
            //oCmd2.Parameters.AddWithValue("OBS", "Consulta Geral");
       ...
       new Action(() =>
       {
        ...
        private void btnOperacoesNaoInteg_Click(object sender, EventArgs e)
        {
        ...
        private void btnVerNaoIntegrados_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Não existe nenhum item selecionado.\nExecute a consulta e selecione uma linha para consultar as operações não integradas.",
